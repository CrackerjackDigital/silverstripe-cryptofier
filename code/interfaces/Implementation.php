...
interface CryptofierImplementationInterface {
    ...
    /**
     * Native single pass encryption of value using key. Not really an 'interface' method but included here
     * for completeness. Is declared as abstract on Implementation base class
     *
     * NB: Shouldn't be called externally as doesn't use the server key!
     *
     * @param $value
    ...
    /**
     * Native single pass decryption of value using key. Not really an 'interface' method but included here
     * for completeness. Is declared as abstract on Implementation base class
     *
     * NB: Shouldn't be called externally as doesn't use the server key!
     *
